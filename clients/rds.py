...
def insert_message(twilio_message_id, body, from_phone, to_phone, receive_status, approximate_arrival_timestamp, sequence_number):
    sql = """
        insert into
        message (
            twilio_message_id,
    ...
    sql_params = [
        ...
        {'name': 'receive_status', 'value': {'stringValue': receive_status}},
